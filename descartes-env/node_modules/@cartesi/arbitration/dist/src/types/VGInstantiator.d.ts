...
interface VGInstantiatorInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    "MemoryWriten(uint256)": EventFragment;
    "PartitionDivergenceFound(uint256,uint256)": EventFragment;
    "VGCreated(uint256,address,address,uint256,address,bytes32,bytes32,uint256,uint256)": EventFragment;
    "VGFinished(uint8)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "MemoryWriten"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "PartitionDivergenceFound"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "VGCreated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "VGFinished"): EventFragment;
}

export class VGInstantiator extends Contract {
  ...
  interface: VGInstantiatorInterface;
  ...
  functions: {
    ...
    getState(
      ...
      [
        ...
        _machine: string;
        _initialHash: string;
        _claimerFinalHash: string;
        _hashBeforeDivergence: string;
        _hashAfterDivergence: string;
  ...
  filters: {
    ...
    PartitionDivergenceFound(
      _index: null,
      _mmInstance: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
      { _index: BigNumber; _mmInstance: BigNumber }
    >;
    ...
    VGCreated(
      ...
      _initialHash: null,
      _claimerFinalHash: null,
      _finalTime: null,
      _partitionInstance: null
    ): TypedEventFilter<
      [
        BigNumber,
        string,
      ...
      ],
      {
        ...
        _partitionInstance: BigNumber;
      }
    >;

    VGFinished(
      _finalState: null
    ): TypedEventFilter<[number], { _finalState: number }>;
  };
