...
var func = function (hre) { return __awaiter(void 0, void 0, void 0, function () {
    var deployments, getNamedAccounts, deploy, get, deployer, Merkle, Logger, VGInstantiator, Step;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                Merkle = _a.sent();
                return [4 /*yield*/, get("Logger")];
            case 3:
                Logger = _a.sent();
                return [4 /*yield*/, get("VGInstantiator")];
            case 4:
                VGInstantiator = _a.sent();
                return [4 /*yield*/, get("Step")];
            case 5:
                Step = _a.sent();
                return [4 /*yield*/, deploy("Descartes", {
                        from: deployer,
                        log: true,
                        libraries: {
